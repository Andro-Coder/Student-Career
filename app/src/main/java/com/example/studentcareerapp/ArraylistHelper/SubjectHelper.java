...
public class SubjectHelper extends SQLiteOpenHelper {
    ...
    final static String DBNAME = "SubjectList.db";
    final static int DBVERSION = 1;


    // Create constructor
    public SubjectHelper(@Nullable Context context)
    {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("Drop table if exists tblSubList");
    ...
    public boolean fnInsertItems(String item) {
        ...
        long id = database.insert("tblSubList",null,values);
    ...
    public ArrayList<SubjectDomain> fnGetItems(){

        ArrayList<SubjectDomain> list = new ArrayList<>();
        SQLiteDatabase db = this.getWritableDatabase();

        Cursor cursor = db.rawQuery("Select item from tblSubList",null);
    ...
    public boolean fnCheckItemsExist(String item){
        ...
        Cursor cursor = db.rawQuery("Select * from tblSubList where item = ?",new String[]{item});
    ...
    public void fnRemoveItem(String item) {
        ...
        db.delete("tblSubList",  "item = ?" , new String[] {item} );
    ...
    public void fnDeleteAll() {
        ...
        db.delete("tblSubList", null, null);
