...
public class DepartmentHelper extends SQLiteOpenHelper {

    final static String DBNAME = "DepartmentList.db";
    final static int DBVERSION = 1;


    // Create constructor
    public DepartmentHelper(@Nullable Context context)
    {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("Drop table if exists tblDeptList");
    ...
    public boolean fnInsertItems(String item) {
        ...
        long id = database.insert("tblDeptList",null,values);
    ...
    public ArrayList<DepartmentDomain> fnGetItems(){
        ArrayList<DepartmentDomain> list = new ArrayList<>();
        SQLiteDatabase db = this.getWritableDatabase();

        Cursor cursor = db.rawQuery("Select item from tblDeptList",null);
        ...
        if (cursor.moveToFirst())
        {
            do{
                ...
                DepartmentDomain domain = new DepartmentDomain();
    ...
    public boolean fnCheckItemsExist(String item){
        ...
        Cursor cursor = db.rawQuery("Select * from tblDeptList where item = ?",new String[]{item});
    ...
    public void fnRemoveItem(String item) {
        ...
        db.delete("tblDeptList",  "item = ?" , new String[] {item} );
    ...
    public void fnDeleteAll() {
        ...
        db.delete("tblDeptList", null, null);
